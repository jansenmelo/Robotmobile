...
Então os dados de nome "${Cliente.Usuario}" e console "${Cliente.Console_Preferido}" devem ser gravados com sucesso
      ...
      # ${verificar_usuario}                     Get Webelement               ${campo_nome}
      # Should be Equal                        ${verificar_usuario.text}      ${Cliente.Usuario}

      # ${verificar_console}                   Get Webelement                 ${valor_console}
      # Should be Equal                        ${verificar_console.text}      ${Cliente.Console_Preferido}
